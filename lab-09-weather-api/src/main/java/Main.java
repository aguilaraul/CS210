...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String line : lines) {
            if (line.contains("\"forecast\":")) {
                forecastURL = getJSONValueFromLine(line);
        ...
        for (String line : lines) {
            if(line.contains("\"temperature\":")) {
                temp = getJSONValueFromLine(line);
                break;
            }
        }
        ...
        if(temperature >= 75) {
            System.out.println("Shorts and t-shirt weather.");
        }
        if(temperature >= 60) {
            System.out.println("Looks like a nice day.");
        }
        if(temperature <= 59) {
            System.out.println("Might want to grab a sweater");
        }
